...
// inserir imagens via shortcode
function imgFund($params) {

	$a = shortcode_atts([
		'nome' => 0,
	], $params);
	
	return "<img src='http://".$_SERVER['HTTP_HOST']."/seak1/wp-content/uploads/2020/11/".$a['nome']."'>";
}

// criando o shortcode
add_shortcode('imagemFundadores', 'imgFund');



// inserir imagens via shortcode
function insereImg($params) {

	$a = shortcode_atts([
		'nome' => 0,
	], $params);
	
	return "<img src='http://".$_SERVER['HTTP_HOST']."/seak1/wp-content/uploads/".$a['nome']."'>";
}

// criando o shortcode
add_shortcode('insereImagem', 'insereImg');
